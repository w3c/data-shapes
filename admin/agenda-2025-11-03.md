...
This is a new specification aiming that has been created to aim for a cleaner separation between "core" SHACL functions and extended functions that can be defined with SPARQL. The previous version of SHACL did not make this distinction.
